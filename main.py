...
class SEOContentOptimizer:
    ...
    def run_content_generation(self):
        ...
        try:
            ...
            # Step 2: Select input Excel file (with folder choice)
            print_section("Select Input Excel File", "2/6")
            print("📁 Select source folder for Excel files:")
            print("   [1] output/ - Files generated from content optimization mode")
            print("   [2] input/  - Your own Excel files")
            print()
            
            folder_choice = input("Select folder (1 or 2, default: 1): ").strip()
            ...
            selected_files = self.file_selector.select_files_interactive(custom_dir=source_dir)
            ...
            if not selected_files:
                ...
                if source_dir == "output":
                    ...
                    print("\n   Or select input/ folder to use your own Excel files.")
                return
    ...
    def run_synonym_finder(self):
        ...
        try:
            ...
            print("📁 Excel files should have keywords in the first column")
            print()
            
            # For synonym finder, default to input/ but allow output/ too
            selected_files = self.file_selector.select_files_interactive()
