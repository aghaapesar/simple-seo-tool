...
- برای پاراگراف‌ها از <p> استفاده کن

**نکات بسیار مهم:**
1. **هیچ نتیجه‌گیری یا جمع‌بندی برای این بخش ننویس** - فقط محتوای اصلی
2. **نتیجه‌گیری کلی مقاله در انتها خواهد آمد**
3. این بخش باید به صورت یک جریان طبیعی محتوا باشد نه یک مقاله مستقل
4. از عبارات مثل "در نتیجه"، "خلاصه"، "بنابراین" در انتهای این بخش استفاده نکن
...
**خروجی:**
فقط متن مقدمه با فرمت HTML ساده:
- استفاده از <p> برای پاراگراف‌ها
- استفاده از <strong> برای تاکید
- بدون هیچگونه تگ <h2> یا عناصر اضافی
- متنی که در مرورگر کاملاً تمیز و خوانا باشد
"""
...
**دستورالعمل:**
یک نتیجه‌گیری قوی، جامع و کاربردی برای **کل مقاله** بنویس.

**الزامات:**
- طول: 150-200 کلمه
- جمع‌بندی **همه نکات کلیدی** مطرح شده در مقاله
- ارائه توصیه‌های نهایی و کاربردی
- دعوت به اقدام (CTA) در صورت مناسب بودن
- خاتمه قوی و به یادماندنی
- **این تنها نتیجه‌گیری مقاله است** - جامع و کامل باشد

**خروجی:**
فقط متن نتیجه‌گیری با فرمت HTML ساده:
- استفاده از <p> برای پاراگراف‌ها
- استفاده از <strong> برای تاکید
- بدون هیچگونه تگ <h2> یا عناصر اضافی
- متنی که در مرورگر کاملاً تمیز و خوانا باشد
